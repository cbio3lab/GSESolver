...
data <- read.csv('DATABASES/SolCbio3_fps.csv')
...
ggsave(p, filename = 'PLOTS/correlacion_logSo/tSNE_fps.png', width = 7, height = 6, units = 'in')
ggsave(p, filename = 'PLOTS/correlacion_logSo/tSNE_fps.pdf', width = 7, height = 6, units = 'in')
